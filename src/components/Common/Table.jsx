...
const TableList = ({
  ...
  /* ----------------------------------------------------------
      COLUMNS (updated with center alignment and word-wrap for name)
  ------------------------------------------------------------ */
  const generateColumns = () =>
    Header.map((column) => ({
      ...
      key: column.value,
      width: column.value === "move" ? 60 : column.value === "index" ? 70 : column.value === "order" ? 80 : column.value === "name"
        ? 220 : "auto",
      align: 'center',
      ellipsis: false,  
      sorter: column.sort
      ...
      render: (record, row, index) => {
        ...
        if (column.value === "actions")
          return (
            <div className="actions d-flex gap-1 justify-content-center">
        ...
        // ⭐ FIX: Wrap "name" column content with hyphens for long words
        if (column.value === "name") {
          ...
          const addSoftHyphens = (text) => {
            ...
            return text
              // Add soft hyphen between camelCase transitions
              .replace(/([a-z])([A-Z])/g, '$1\u00AD$2')
              // Add soft hyphen every 10 characters
              .replace(/(.{10})/g, '$1\u00AD');
          };
  ...
  return (
    <div>
      ...
      <style>{`
        ...
        /* ⭐ FORCE TABLE LAYOUT FIXED AND NO HORIZONTAL SCROLL */
        .ant-table {
        ...
        /* ⭐ NAME COLUMN - Display soft hyphens properly */
        .name-cell-wrapper {
        ...
        /* ⭐ ENSURE OTHER CELLS WRAP CONTENT */
